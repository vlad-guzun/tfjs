...
import { ArrowDownToLine, AtSign, EllipsisVertical, Settings2, Share2, Trash } from "lucide-react";
import { DeleteReelDialog } from "./DeleteReelDialog";
import { EditReelDialog } from "./EditReelDialog";

export function OptionsReelPopover({ reel }: { reel: VideoPostProps }) {
